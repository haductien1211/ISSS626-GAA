...
Focus on gwr random forest use 53 trees instead of 500 trees since the sample data is big and also use 1 by 1 data, 3 room flat, 4 room flat. Could use r5r package to calculate shortest distance from a road network
...
Get a list of shopping malls name from wikipedia then create a list
