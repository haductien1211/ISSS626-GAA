...
`spNetwork` package is expecting the geospatial data contains complete CRS information
...
Changing `tmap` mode back to 'plot'
...
The user guide of `spNetwork` package provide a comprehensive discussion of `nkde()`. We should read them at least once to have a basic understanding of the various parameters that can be used to calibrate the NKDE model.
