...
We need to ensure that spdep, sf, tmap and tidyverse packages of R are currently installed in R.
...
**the meaning of “Average number of links: 3.681818” mean that there are on average 3.681818 nearest neighbors for each point that satisfy the distance between 0-62 km**
